...
var userCalories = 2000; //placeholder values; these will be passed in from the user's daily stat page
var userWater = 125;
var userVeggie = 3;
var userProtein = 5;
...
console.log(healthScore(userCalories, userWater, userVeggie, userProtein));
